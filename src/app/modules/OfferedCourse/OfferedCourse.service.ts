...
const getMyOfferedCoursesFromDB = async (
  ...
  console.log('Current Semester:', currentOngoingRegistrationSemester);
  ...
  const initialMatch = await OfferedCourse.find({
  ...
  const aggregationQuery = [
    ...
    },
    {
      $lookup: {
        ...
        let: {
          currentSemester: currentOngoingRegistrationSemester._id,
